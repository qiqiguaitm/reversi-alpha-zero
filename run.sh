...
CUDA_VISIBLE_DEVICES='2' nohup ../anaconda3/bin/python -u  src/reversi_zero/run.py opt > out.`hostname`.opt 2>&1 &
CUDA_VISIBLE_DEVICES='3' nohup ../anaconda3/bin/python -u src/reversi_zero/run.py eval > out.`hostname`.eval 2>&1 &